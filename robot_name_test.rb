...
=begin
  - calling Kernel.srand with the initial number sets the name to one thing
  - calliing Kernel.srand with the same number sets the name to the same thing
  - both names are going to be equal
=end